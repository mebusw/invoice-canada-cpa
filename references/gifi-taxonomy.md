...
| 层 | Owner | 回答的问题 |
|---|---|---|
| Transaction | 企业 | 发生了什么 |
| COA | 企业 | 怎么记账 |
| Expense Category | 企业/软件 | 怎么看账（管理口径） |
| Financial Statement Line | 会计准则 | 报表怎么呈现 |
| **GIFI code** | **CRA** | **CRA 怎么读你的报表** |
| T2 Schedule 125 | CRA | 申报表怎么填 |
| Tax Treatment | 税法 | 能不能扣、扣多少 |
| Schedule 1 | CRA | 账面利润怎么调成应税所得 |
...
| Operating Expenses | 8520–9368 | Income Statement |
| Farming | 9370–9898 | Income Statement |
| Tax / Extraordinary / Net Income | 9970–9999 | Income Statement |

小计项：`9367 Total Total`（区块小计项）、`9368 Total expenses`、`9369 Net non-farming income`、`8299 Total revenue`。**这些是 total 项，绝不能用来给单张收据归类。**
...
| 8590 = Interest and bank charges | — | 8710 |
...
> 根因：这些多数是 **T2125（个体户 Statement of Business Activities）行号**或凭印象编造的号段，被误当成 GIFI。判定标准：能否在 CRA Appendix A 中查到。

## 5. Tax Treatment 轴（与 GIFI 映射相互独立）

GIFI 决定「报表怎么归类」，税务处理决定「能扣多少」。两条轴分开存储。
